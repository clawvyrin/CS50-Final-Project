...
import 'package:task_companion/providers/project_member_provider.dart';
...
class MembersTab extends ConsumerWidget {
  ...
  void _showAddMemberSearch(BuildContext context, WidgetRef ref) {
    // Ici, tu réutilises ta GlobalSearchPage
    // Mais on peut passer un paramètre 'onSelect' pour ajouter le membre au projet
    context.pushNamed(
      'global_search',
  ...
  void _confirmDeletion(
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          "Voulez-vous vraiment retirer ${member.profile.displayName} de ce projet ? "
